...
public class GeoHash {
	...
	public GeoHash(double lat, double lng,int latLength,int lngLength) {
	...
	public static void main(String[] args) {
		...
		Date start =new Date();
		String blokcString=BlockUtil.getBlockCode("120.156077,30.287459");
		GeoHash g = new GeoHash(30.287459, 120.156077,20,20);
		System.out.println(blokcString);
		List<String> list=BlockUtil.getBlockCodeFor9("120.156077,30.287459");
		for(String s:list){
			System.out.println(s);
		}
		System.out.println(new Date().getTime()-start.getTime()+"毫秒完成");
