...
public class WordFilterUtil{
  ...
  public static void getFilterWords(List<String> wordsList) {
	  if (wordsList != null ) {
  ...
  private static String filter(PunctuationOrHtmlFilteredResult pohResult, char replacement) {
...
//    result.setLevel(Integer.valueOf(level));
  ...
  public static String filterText(String originalString, char replacement, List<String> wordsList)
  {
	  getFilterWords(wordsList);
	  return filter(filterPunctation(originalString), replacement);
  }

  public static String filterHtml(String originalString, char replacement, List<String> wordsList)
  {
	  getFilterWords(wordsList);
